...
<div class="container-fluid">
	...
	<div class="d-sm-flex align-items-center justify-content-between mb-4">
		...
		<a href="registro_proveedor.php" class="btn btn-info"><i class="fas fa-user-plus"></i>&nbsp;NUEVO PROVEEDOR</a>
	</div>
		...
		<div class="col-lg-12">
			<div class="table-responsive">
				<table class="table table-striped table-bordered" id="table">
					<thead class="thead-dark" > <!-- bgcolor="#022424" -->
						<tr align=center>
							<th>Nro</th>
							<th>CONTACTO</th>
							<th>PROVEEDOR</th>
						...
						if ($result > 0) {
							while ($data = mysqli_fetch_assoc($query)) { ?>
								<tr align=center>
									...
									<?php if ($_SESSION['rol'] == 1) { ?>
									<td>
										<a href="editar_proveedor.php?id=<?php echo $data['codproveedor']; ?>" class="btn btn-success"><i class='fas fa-edit'></i> MODIFICAR</a>
