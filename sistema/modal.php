...
if ($_POST['action'] == 'addProductoDetalle') {
  if (empty($_POST['producto']) || empty($_POST['cantidad'])){
    ...
    $token = md5($_SESSION['idUser']); // token= Se utilizan para facilitar las transacciones
    ...
    while ($data = mysqli_fetch_assoc($query_detalle_temp)) {
      ...
      $sub_total = round($sub_total + $precioTotal, 2); // round sirve para redondear
    ...
    <tr>
        <td colspan="5" class="textright">Impuesto(IGV) Bs: ('.$iva.'%)</td>
