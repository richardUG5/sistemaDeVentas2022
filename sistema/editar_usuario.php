    ...
    <div class="col-lg-6 m-auto">
      <div class="card" >
        <div class="card-header text-info" align="center" style="background-color:#022424;"> <!--bg-dark -->
          <i class="fas fa-user-tie fa-fw"></i>&nbsp;MODIFICAR DATOS DE USUARIO
        </div>
        <div class="card-body" style="background-color:#022424;">
            <form class="" action="" method="post">
              ...
              <div class="col-md-12" align="center" style="background-color:#022424;">
                <button type="submit" class="btn btn-outline-success"><i class="fas fa-user-edit"></i>&nbsp;ACTUALIZAR DATOS DE USUARIO</button>&nbsp;
                &nbsp;<a href="lista_usuarios.php" class="btn btn-outline-info"><i class="fas fa-sign-out-alt fa-sm fa-fw mr-2 text-gray-400"></i>&nbsp;CANCELAR</a>
              </div>
            </form>
          </div>
        </div>
