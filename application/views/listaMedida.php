...
<div class="row">
  <div class="col-md-12" >
    <font color="black">
      <h1 style="background-color:darkcyan;" style="color:darkcyan;" style="text-align:center" align="center"><i class="fas fa-cubes"></i> <i class="fas fa-list"></i> LISTA DE MEDIDAS HABILITADOS</h1>
    </font>
  </div>
</div>
...
<!-- HASTA AQUI REPORTE EN PDF -->
  ...
  <div class="col-md-2">
    <?php echo form_open_multipart('usuarios/logout'); ?> <!-- retorna a login -->
      <button type="submit" name="buton3" class="btn btn-outline-success btn-block"> <i class="fas fa-cube"></i> CERRAR SESSION</button>
    <?php echo form_close(); ?>
  </div>
