<div class="right_col " role="main">
  <div class="container md-3"> <!-- para reponsivo de vista -->
    <div class="row">
      ...
      <?php echo form_open_multipart('categoria/agregarbd'); ?>
      <br>
...
<div class="item form-group has-feedback" style="background-color:#1D7070;" style="color:whitesmoke;" style="text-align:center" align="right">
  ...
  <font color="white"> <br>
    ...
    <div class="col-md-12" align="center">
      <font color="cyan">
        <h1><i class="fas fa-tags fa-fw"></i> AGREGAR NUEV@ CATEGORIA</h1>
      </font> 
    </div>
<!--
    <div class="row">
    ...
    <div class="row">
      <div class="col-md-4">
        <label class="col-form-label  label-align" for="PRIMERPELLIDO">NOMBRE CATEGORIA:</label>
      </div>

      <div class="col-md-5">
        <input type="text" name="NombreCategoria" placeholder="Ingrese nombre" class="form-control has-feedback-left" required> <br>
      </div> 
    </div>
<!--
    <div class="row">
  ...
  <div class="col-md-12" align="center" style="background-color:#1D7070;">
    <button type="submit" class="btn btn-outline-success"> <i class="fas fa-tags fa-fw"></i> AGREGAR NUEV@ CATEGORI@</button>
    <?php echo form_close(); ?>
